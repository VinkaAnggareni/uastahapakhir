                ...
                <li class="user-name"><span></span></li>
                  <li class="dropdown avatar-dropdown">
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     <li><a href="#"><span class="fa fa-box"><span class="fa-home fa"></span> Barang</a></li>
              ...
              <div class="sub-left-menu scroll">
                ...
                <div class="container-fluid mimin-wrapper">
                    ...
                    <li class=" ripple">
                      ...
                      <span class="fa-home fa"></span><a href="{{route('home')}}">Home</a>
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                      
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header"><span class="fa-box"></span>
                      <span class="fa fa-cubes fa"></span><a href="{{route('nonbarang')}}">Barang</a>
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                      
                    </li>
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        ...
                        <span class="fa-users fa"></span> <a href="{{route('nonadminpembeli')}}">Pembeli</a> 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                      
                    </li>
