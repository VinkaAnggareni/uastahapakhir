              ...
              <div class="sub-left-menu scroll">
                ...
                <div class="container-fluid mimin-wrapper">
                    ...
                    <li class="ripple">
                      ...
                      <a href="{{route('barang.index')}}"><span class="fa-cubes fa"></span>Barang</a>
                    ...
                    <li class="ripple">
                      ...
                      <span class="fa-people"></span>
                        <a href="{{route('penjual.index')}}"> <span class="fa-user fa"></span>Penjual</a> 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                      
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-people"></span>
                        <a href="{{route('pembeli.index')}}"><span class="fa fa-users fa"></span> Pembeli</a> 
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>                      
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-"></span>
                    <a href="{{route('supplier.index')}}"><span class="fa fa-male"></span>Supplier</a> 
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>                      
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-store"></span>
                    <a href="{{route('gudang.index')}}"><span class="fa fa-university"></span>Gudang</a> 
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa"></span>
                    <a href="{{route('pembelian.index')}}"><span class="fa fa-shopping-cart"></span>Pembelian</a>
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      
                    </li>
                    <li class="ripple"><a href="calendar.html">
                    <span class="fa fa"></span>
                    <a href="{{route('penjualan.index')}}"><span class="fa fa-pencil-square-o"></span>Penjualan</a>
                    <span class="fa-angle-right fa right-arrow text-right"></span></a>
                    </li>          
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-"></span>
                    <a href="{{route('detailpembelian.index')}}"><span class="fa fa-list-alt"></span>Detail Pembelian</a> 
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-"></span>
                    <a href="{{route('detailpenjualan.index')}}"><span class="fa fa-archive"></span>Detail Penjualan</a> 
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    <span class="fa fa-"></span>
                    <a href="{{route('joinpembelian.index')}}"><span class="fa fa-file-text-o"></span>Nota Pembelian</a> 
                    <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
