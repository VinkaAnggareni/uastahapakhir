...
class DetailpenjualanController extends Controller
{
    ...
    public function create()
    {
        ...
        //dd($barang);
        $pilihan=penjualan::all();

    

        $pilih=barang::all();

        return view('admin.inputdetailpenjualan',compact('pilih','pilihan','detailpenjualan'));
    }
    ...
    {
        //
        $data=Detailpenjualan::create($request->all());
        return redirect('detailpenjualan')->with('succses','Data berhasil diupdate');
